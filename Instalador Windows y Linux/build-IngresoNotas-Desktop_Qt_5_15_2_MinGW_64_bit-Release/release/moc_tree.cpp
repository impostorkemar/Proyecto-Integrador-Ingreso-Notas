...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    qptrdiff(offsetof(qt_meta_stringdata_Tree_t, stringdata0) + ofs \
        - idx * sizeof(QByteArrayData)) \
    )
static const qt_meta_stringdata_Tree_t qt_meta_stringdata_Tree = {
    {
QT_MOC_LITERAL(0, 0, 4), // "Tree"
QT_MOC_LITERAL(1, 5, 19), // "on_Regresar_clicked"
QT_MOC_LITERAL(2, 25, 0) // ""

    },
    "Tree\0on_Regresar_clicked\0"
};
...
QT_INIT_METAOBJECT const QMetaObject Tree::staticMetaObject = { {
    QMetaObject::SuperData::link<QWidget::staticMetaObject>(),
    qt_meta_stringdata_Tree.data,
    qt_meta_data_Tree,
    qt_static_metacall,
    nullptr,
    nullptr
...
void *Tree::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_Tree.stringdata0))
